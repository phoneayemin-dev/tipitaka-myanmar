...
import 'package:tipitaka_myanmar/data/theme_data.dart';
...
class _ReaderState extends State<Reader> {
        ...
        appBar: AppBar(
          ...
          actions: [
            ...
            IconButton(
                ...
                onPressed: () {
                  List<AppTheme> themes = MyTheme.fetchAll();
                  List<MaterialColor> colors = [];
                  themes.forEach((theme) {
                    colors
                        .add(MaterialColor(theme.data.primaryColor.value, {}));
                  });
                  return showDialog(
                      context: context,
  ...
  _changePage(int pageNumber) {
    ...
    RecentDatabaseRepository(DatabaseProvider()).insertOrUpdate(Recent(_book.id, currentPage));
  }
