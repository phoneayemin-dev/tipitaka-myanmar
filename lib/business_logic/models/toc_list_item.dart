...
class TocHeadingOne implements TocListItem {
  ...
  @override
  Widget build(BuildContext context) {
    return Text(toc.name, style: TextStyle(fontWeight: FontWeight.bold));
  }
}
...
class TocHeadingTwo implements TocListItem {
  ...
  @override
  Widget build(BuildContext context) {
    return Padding(padding: EdgeInsets.only(left: 16.0), child: Text(toc.name));
  }
}
...
class TocHeadingThree implements TocListItem {
  ...
  @override
  Widget build(BuildContext context) {
    return Padding(padding: EdgeInsets.only(left: 32.0), child: Text(toc.name));
  }
}
...
class TocHeadingFour implements TocListItem {
  ...
  @override
  Widget build(BuildContext context) {
    return Padding(padding: EdgeInsets.only(left: 48.0), child: Text(toc.name));
  }
}
...
class TocHeadingFive implements TocListItem {
  ...
  @override
  Widget build(BuildContext context) {
    return Padding(padding: EdgeInsets.only(left: 64.0), child: Text(toc.name));
  }
}
